#This code is greatly inspired from the code at the following site : https://ubidots.com/blog/setup-raspberry-wifi-ubidots-send-data/
...
def wifi_connect(network, ssid, psk):
...
def handle_client(client_sock) :
    ...
    ip_address = wifi_connect(network, ssid, psk)
...
try:
    while True:
        ...
        #Uncomment to enable code from site (connect to wifi)
